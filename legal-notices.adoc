...
* link:./media/mgmt_svcs_2.21_notice.pdf["관리 서비스 2.21.61 알림(VMware vCenter Server 4.10.12용 NetApp Element 플러그인)"^]
* link:./media/mgmt_2.20_notice.pdf["관리 서비스 2.20.69 공지(vCenter Server 4.9.14용 NetApp Element 플러그인)"^]
* link:./media/mgmt_2.19_notice.pdf["관리 서비스 2.19.48 공지(vCenter Server 4.8.34용 NetApp Element 플러그인)"^]
* link:./media/mgmt_svcs_2.18.pdf["관리 서비스 2.18.91 공지(vCenter Server 4.7.10용 NetApp Element 플러그인)"^]
* link:./media/mgmt_2.17.56_notice.pdf["관리 서비스 2.17.56 공지(vCenter Server 4.6.32용 NetApp Element 플러그인)"^]
* link:./media/mgmt-217.pdf["관리 서비스 2.17.52 공지(vCenter Server 4.6.29용 NetApp Element 플러그인)"^]
* link:./media/mgmt-216.pdf["관리 서비스 공지 2.16(vCenter Server 4.6.29용 NetApp Element 플러그인)"^]
* link:./media/mgmt-214.pdf["관리 서비스 공지 2.14(vCenter Server 4.5.42용 NetApp Element 플러그인)"^]
* link:./media/mgmt-213.pdf["관리 서비스 공지 2.13(vCenter Server 4.5.42용 NetApp Element 플러그인)"^]
